...
class User 
{
  ...
  //staticheskiy metod dobavleniya pol'zovatelya
    ...
    //echo "Пользователь добавлен";
      ...
      if ($result->num_rows != 0) {
        ...
        $mysqli->query("INSERT INTO `users`(`name`, `lastname`, `email`, `pass`) VALUES ('$name', '$lastname',
        '$email', '$pass')");
  ...
  static function authUser($email, $pass) 
  {
    ...
    if(password_verify($pass, $result["pass"])) {
      ...
      return json_encode(["result" => "dnExist"]);
    }
  }
